...
<form class="form-horizontal" method="post" action="" >
		...
		<div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="sp" name="sp" placeholder="Tên Sản Phẩm" value="<?=$sp->TenSanPham?>">
            </div> 
         </div>
          <div class="control-group">
            <label class="control-label" for="inputLnam">Mô Tả <sup>*</sup></label>
            <div class="controls">
            <textarea name="mota" id="mota" cols="45" rows="5"><?=$sp->MoTaSanPham?></textarea>
        ...
        <div class="control-group">
            <label class="control-label" for="inputLnam">Hình <sup>*</sup></label>       
                <div class="controls">
                    <input type="text" id="hinh" name="hinh" placeholder="Hình"><?=$sp->HinhAnhSanPham?>                          
                     <input onclick="BrowseServer('../Views/img/products/','hinh')" type="button" id="btnChonFile" name="btnChonFile" value="Chọn Hình" action="none" >       
                </div>
            </div>        
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input type="text" id="gia" name="gia" placeholder="Giá" value="<?=$sp->DonGia?>">
            </div>
        </div>
       ...
       <div class="control-group">
            ...
            <div class="controls">
            <input type="text" id="soluong" name="soluong" placeholder="Số lượng tồn" value="<?=$sp->SoluongTon?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <select name="madanhmuc" id="madanhmuc">
                    <?php
                        foreach($TL as $tll){                   
                    ?>
                      <option <?php if($tll->MaDanhMuc == $sp->MaDanhMuc) echo "selected ='selected'" ?> value="<?php echo $tll->MaDanhMuc ?>"><?php echo $tll->TenDanhMuc ?></option>
        ...
        <div class="control-group">
         ...
         <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="tomtat" name="tomtat" placeholder="Tóm Tắt" value="<?=$sp->TomTat?>">
            </div> 
         </div>
	...
	<div class="control-group">
			<div class="controls">
				...
				<input class="btn btn-large btn-success" type="submit" value="Sửa"  name="btnSuaSP"/>
			</div>
		</div>		
	</form>
</div>
